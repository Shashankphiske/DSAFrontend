        ...
        <div className='rounded-xl flex flex-col justify-center gap-10 bg-neutral-950 p-12 w-2/5'>
            <div className='flex flex-row justify-between gap-10 w-full'>
                <div className='flex flex-col justify-center gap-4'>
                    ...
                    <input type="text" placeholder='John Doe' className='text-[1.2vw] rounded-xl p-4 border-[1px] border-gray-800'/>
                </div>
                <div className='flex flex-col justify-center gap-4'>
                    <p className='text-[1.2vw]'>Your Email *</p>
                    <input type="text" placeholder='johndoe@gmail.com' className='text-[1.2vw] rounded-xl p-4 border-[1px] border-gray-800'/>
                </div>
            </div>
            <div className='flex w-full flex-col gap-4 justify-center'>
                <p className='text-[1.2vw]'>Share Your Experience *</p>
                <textarea type="text" placeholder='Your thoughts ...' className='text-[1.2vw] p-4 w-full border-[1px] border-gray-800 rounded-xl min-h-40'/>
            </div>
            <button className='px-2 py-2 rounded-xl bg-blue-500 hover:bg-blue-600 text-[1.2vw] w-[10vw]'>Submit</button>
        </div>
    </div>
  )
}
